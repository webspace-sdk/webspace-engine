...
function ScreenQuad(params) {
  ...
  const debug = undefined !== params.debug ? params.debug : false;
  ...
  this.renderOrder = RENDER_ORDER.PICTURE_IN_PICTURE;
  ...
  //resolve the pairs
  for (const p in this._pairs) this._initPair(params, this._pairs[p]);
