...
export class HapticFeedbackSystem {
  ...
  tick(twoPointStretchingSystem, interactLeft, interactRight) {
    ...
    this.leftTeleporter = this.leftTeleporter || DOM_ROOT.querySelector("#player-left-controller").components.teleporter;
    this.rightTeleporter =
      this.rightTeleporter || DOM_ROOT.querySelector("#player-right-controller").components.teleporter;
