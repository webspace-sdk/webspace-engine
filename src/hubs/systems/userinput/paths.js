...
paths.actions.toggleKeyTips = "/actions/toggleKeyTips";
...
paths.actions.mediaSnapshotAction = "/actions/mediaSnapshotAction";
paths.actions.mediaUpAction = "/actions/mediaUpAction";
paths.actions.mediaDownOrResetAction = "/actions/mediaDownOrResetAction";
paths.actions.mediaExit = "/actions/mediaExit";
paths.actions.mediaRotateAction = "/actions/mediaRotate";
paths.actions.mediaScaleAction = "/actions/mediaScale";
...
paths.actions.mediaSlideAction = "/actions/mediaSlide";
paths.actions.mediaSlideReleaseAction = "/actions/mediaSlideRelease";
paths.actions.mediaLiftAction = "/actions/mediaLift";
paths.actions.mediaLiftReleaseAction = "/actions/mediaLiftRelease";
paths.actions.mediaToggleLockAction = "/actions/mediaToggleLock";
...
paths.actions.transformAxisNextAction = "/actions/transformAxisNextAction";
paths.actions.transformAxisPrevAction = "/actions/transformAxisPrevAction";
paths.actions.transformRotateNextAction = "/actions/transformRotateNextAction";
paths.actions.transformRotatePrevAction = "/actions/transformRotatePrevAction";
paths.actions.undo = "/actions/undo";
paths.actions.redo = "/actions/redo";
paths.actions.equip1 = "/actions/equip1";
paths.actions.equip2 = "/actions/equip2";
paths.actions.equip3 = "/actions/equip3";
paths.actions.equip4 = "/actions/equip4";
paths.actions.equip5 = "/actions/equip5";
paths.actions.equip6 = "/actions/equip6";
paths.actions.equip7 = "/actions/equip7";
paths.actions.equip8 = "/actions/equip8";
paths.actions.equip9 = "/actions/equip9";
paths.actions.equip0 = "/actions/equip0";
paths.actions.nextMediaLayer = "/actions/nextMediaLayer";
paths.actions.previousMediaLayer = "/actions/previousMediaLayer";
paths.actions.mediaLayer1 = "/actions/mediaLayer1";
paths.actions.mediaLayer2 = "/actions/mediaLayer2";
paths.actions.mediaLayer3 = "/actions/mediaLayer3";
paths.actions.mediaLayer4 = "/actions/mediaLayer4";
paths.actions.mediaLayer5 = "/actions/mediaLayer5";
paths.actions.mediaLayer6 = "/actions/mediaLayer6";
paths.actions.mediaLayer7 = "/actions/mediaLayer7";
paths.actions.mediaLayer8 = "/actions/mediaLayer8";
paths.actions.mediaLayer9 = "/actions/mediaLayer9";
paths.actions.transformModifier = "/actions/transformModifier";
paths.actions.transformScroll = "/actions/transformScroll";
...
paths.actions.cursor.right.mediaScroll = "/actions/cursor/right//mediaScroll";
...
paths.actions.toggleInspecting = "/actions/toggleInspecting";
paths.actions.stopInspecting = "/actions/stopInspecting";
paths.actions.inspectZoom = "/actions/inspectZoom";
paths.actions.inspectPanX = "/actions/inspectPanX";
paths.actions.inspectPanY = "/actions/inspectPanY";
paths.actions.inspectRotateX = "/actions/inspectRotateX";
paths.actions.inspectRotateY = "/actions/inspectRotateY";
