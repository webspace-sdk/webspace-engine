    ...
    for (let i = 0; i < quads.length; i++) {
      ...
      switch (d) {
        case 0:
          if (up) {
            pushFace(
              [x4 * VOXEL_SIZE, y4 * VOXEL_SIZE, z4 * VOXEL_SIZE],
              [x1 * VOXEL_SIZE, y1 * VOXEL_SIZE, z1 * VOXEL_SIZE],
              [x2 * VOXEL_SIZE, y2 * VOXEL_SIZE, z2 * VOXEL_SIZE],
              [x3 * VOXEL_SIZE, y3 * VOXEL_SIZE, z3 * VOXEL_SIZE],
              0,
              0,
              Math.abs(z1 - z3),
              Math.abs(y1 - y3),
