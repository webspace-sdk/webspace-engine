...
class Sky extends Mesh {
  constructor() {
    ...
    this.material = window.APP.effectsQuality === "low" ? this.lowMaterial : this.highMaterial;
  ...
  onAnimationTick({ delta }) {
    const mat = window.APP.effectsQuality === "low" ? this.lowMaterial : this.highMaterial;
