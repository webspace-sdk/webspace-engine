export const PRIMARY_SUB0 = "#050E2E";
export const PRIMARY_0 = "#061139";
export const PRIMARY_1 = "#111749";
export const PRIMARY_1B = "#151c5b";
export const PRIMARY_2 = "#19216C";
export const PRIMARY_3 = "#2D3A8C";
export const PRIMARY_4 = "#35469C";
export const PRIMARY_5 = "#4055A8";
export const PRIMARY_6 = "#4C63B6";
export const PRIMARY_7 = "#647ACB";
export const PRIMARY_8 = "#7B93DB";
export const PRIMARY_9 = "#98AEEB";
export const PRIMARY_10 = "#BED0F7";
export const PRIMARY_10B = "#CFDCF8"; // eslint-disable-line
export const PRIMARY_11 = "#E0E8F9";
export const PRIMARY_11B = "#F0F4FC"; // eslint-disable-line
export const PRIMARY_12 = "#FFFFFF"; // eslint-disable-line
export const NEUTRAL_1 = "#0F1923";
export const NEUTRAL_2 = "#1F2933";
export const NEUTRAL_3 = "#323F4B"; // eslint-disable-line
export const NEUTRAL_4 = "#3E4C59"; // eslint-disable-line
export const NEUTRAL_5 = "#52606D"; // eslint-disable-line
export const NEUTRAL_6 = "#616E7C";
export const NEUTRAL_7 = "#7B8794"; // eslint-disable-line
export const NEUTRAL_8 = "#9AA5B1";
export const NEUTRAL_9 = "#CBD2D9";
export const NEUTRAL_10 = "#E4E7EB";
export const NEUTRAL_11 = "#F5F7FA";
export const ACCENT_1_1 = "#035388";
export const ACCENT_1_2 = "#0B69A3"; // eslint-disable-line
export const ACCENT_1_3 = "#127FBF";
export const ACCENT_1_4 = "#1992D4"; // eslint-disable-line
export const ACCENT_1_5 = "#2BB0ED"; // eslint-disable-line
export const ACCENT_1_6 = "#40C3F7"; // eslint-disable-line
export const ACCENT_1_7 = "#5ED0FA"; // eslint-disable-line
export const ACCENT_1_8 = "#81DEFD";
export const ACCENT_1_9 = "#B3ECFF"; // eslint-disable-line
export const ACCENT_1_10 = "#E3F8FF"; // eslint-disable-line
export const ACCENT_2_1 = "#841003"; // eslint-disable-line
export const ACCENT_2_2 = "#AD1D07"; // eslint-disable-line
export const ACCENT_2_3 = "#C52507"; // eslint-disable-line
export const ACCENT_2_4 = "#DE3A11"; // eslint-disable-line
export const ACCENT_2_5 = "#F35627"; // eslint-disable-line
export const ACCENT_2_6 = "#F9703E";
export const ACCENT_2_7 = "#FF9466"; // eslint-disable-line
export const ACCENT_2_8 = "#FFB088"; // eslint-disable-line
export const ACCENT_2_9 = "#FFD0B5"; // eslint-disable-line
export const ACCENT_2_10 = "#FFE8D9"; // eslint-disable-line
export const ACCENT_3_1 = "#610316"; // eslint-disable-line
export const ACCENT_3_2 = "#8A041A"; // eslint-disable-line
export const ACCENT_3_3 = "#AB091E";
export const ACCENT_3_4 = "#CF1124";
export const ACCENT_3_5 = "#E12D39";
export const ACCENT_3_6 = "#EF4E4E";
export const ACCENT_3_7 = "#F86A6A"; // eslint-disable-line
export const ACCENT_3_8 = "#FF9B9B"; // eslint-disable-line
export const ACCENT_3_9 = "#FFBDBD"; // eslint-disable-line
export const ACCENT_3_10 = "#FFE3E3"; // eslint-disable-line
export const ACCENT_4_1 = "#014D40";
export const ACCENT_4_2 = "#0C6B58";
export const ACCENT_4_3 = "#147D64";
export const ACCENT_4_4 = "#199473";
export const ACCENT_4_5 = "#27AB83";
export const ACCENT_4_6 = "#3EBD93";
export const ACCENT_4_7 = "#64D6AD"; // eslint-disable-line
export const ACCENT_4_8 = "#8EEDC7";
export const ACCENT_4_9 = "#C6F7E2"; // eslint-disable-line
export const ACCENT_4_10 = "#EFFCF6"; // eslint-disable-line
export const TEXT_1_SIZE = "12px";
export const TEXT_2_SIZE = "14px";
export const TEXT_3_SIZE = "16px";
export const TEXT_4_SIZE = "18px";
export const TEXT_5_SIZE = "20px";
export const TEXT_6_SIZE = "24px"; // eslint-disable-line
export const TEXT_7_SIZE = "30px"; // eslint-disable-line
export const TEXT_8_SIZE = "36px"; // eslint-disable-line
export const TEXT_9_SIZE = "48px"; // eslint-disable-line
export const TEXT_10_SIZE = "60px"; // eslint-disable-line
export const TEXT_11_SIZE = "72px"; // eslint-disable-line
export const TEXT_1_WEIGHT = "400";
export const TEXT_2_WEIGHT = "700";
export const TEXT_3_WEIGHT = "900";
export const SMALL_TEXT_SIZE = TEXT_3_SIZE;
export const SMALL_TEXT_WEIGHT = TEXT_1_WEIGHT;
export const SMALL_TEXT_SEMI_BOLD_WEIGHT = TEXT_2_WEIGHT; // eslint-disable-line
export const SMALL_TEXT_BOLD_WEIGHT = TEXT_3_WEIGHT; // eslint-disable-line
export const XSMALL_TEXT_SIZE = TEXT_1_SIZE;
export const XSMALL_TEXT_WEIGHT = TEXT_1_WEIGHT;
